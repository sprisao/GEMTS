...
const DetailsCuration = props => {
  ...
  return (<ScrollView style={styles.detailsCuration} bounces={false}>
    <View style={styles.curationContainer}>
      <FastImage
        source={{ uri: storeData.curation[0].url }}
        style={{
          width: Dimensions.get("window").width, height: scaledHeight,
        }}
...
const styles = StyleSheet.create({
  detailsCurationWrapper: { flex: 1, width: "100%", paddingHorizontal: 10 }, detailsCurationHeader: {
    fontFamily: "SD-B", fontSize: 22, marginVertical: 7, letterSpacing: -1,
  }, curationContainer: {
    width: "100%",
  },
});
